<nav class="sticky top-0 z-10 w-full flex flex-col items-end">
        ...
        <!-- Le reste des boutons -->
         <div class="flex flex-row items-center justify-end space-x-4 w-4/5">
            ...
            <a href="/html/bo/creation_produit.php" class="flex flex-row items-center space-x-2">
                <button class="flex flex-row justify-around items-center border-2 border-black rounded-2xl m-2 p-1">
    ...
    <div id="menuBurger" class="bg-vertMoyen hidden absolute top-25 flex flex-col items-center m-2 p-2  mt-0 w-60 rounded-b-2xl rounded-t-none border-2 border-t-0 border-bleu">
        <ul class="space-y-3 md:space-y-3">
                <li class="text-bleu"><a href="/html/bo/profil_vendeur.php">Profil</a></li>
                <hr>
                <li class="text-bleu"><a href="/html/bo/commande.php">Commandes</a></li>
                <hr>

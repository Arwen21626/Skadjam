...
<nav class="fixed left-0 right-0 bottom-0 w-full z-10 md:sticky md:top-0 flex flex-col items-end">
    ...
    <?php if ($_SESSION['role'] == "client") { ?>
    <div id="menuBurger" class="bg-beige hidden md:absolute md:top-14 flex flex-col items-center m-2 p-2 mb-0 w-40 rounded-t-2xl md:mt-0 md:w-60 md:rounded-b-2xl md:rounded-t-none order-1 md:order-2 md:border-2 md:border-t-0 md:border-black">

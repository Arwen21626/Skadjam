<footer class="bg-vertClair text-vertFonce 
    ...
    <article class="flex flex-col max-w-1/2 pt-1 pr-2 pb-2 pl-2 md:max-w-fit md:pt-0.5 md:pr-1 md:pb-1 md:pl-1">
        ...
        <a class="hover:text-rouge m-1" href="/html/fo/cgv_fo.php">
        ...
        <a class="m-1 text-bleu hover:text-beige" href="/html/fo/ml_fo.php">
            Mentions Légales
        </a>
    </article>
    ...
    <article class="flex flex-col max-w-1/2 pt-1 pr-2 pb-2 pl-2 md:max-w-fit md:pt-0.5 md:pr-1 md:pb-1 md:pl-1">
        ...
        <a class="hover:text-rouge m-1" href="mailto:questions@cobrec.bzh">questions@cobrec.bzh</a>
        <a class="hover:text-rouge m-1" href="tel:0295264512">02 95 26 45 12</a>
    </article>

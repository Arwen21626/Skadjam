...
<body>
    ...
    <main class="m-10 mt-2 flex flex-col">
        ...
        <p>Les présentes conditions de vente sont conclues d’une part par la coopérative <abbr title="Coopérative Bretonne de E-Commerce">COBREC</abbr> au capital social de 150000€ dont le siège social est situé à Lannion, immatriculée au <abbr title="Registre du Commerce et des Sociétés">RCS</abbr> de Lannion sous le numéro 508 977 303. Ci-après dénommée <abbr title="Coopérative Bretonne de E-Commerce">COBREC</abbr> et gérant le site Alizon.bzh et, d’autre part, par toute personne physique ou morale souhaitant procéder à un achat via le site internet Alizon.bzh dénommée ci-après « l’Acheteur ».</p>
        <article>
            <h3 class="ml-5">Article 1 : Commande et modalités de paiement</h3>
            <p>Avant toute commande, l’Acheteur doit créer un compte sur le site Alizon.bzh. <abbr title="Coopérative Bretonne de E-Commerce">COBREC</abbr> La création d’un compte client est nécessaire pour commander. L’Acheteur sélectionne ses produits, confirme son panier, renseigne ses informations, choisit un mode de livraison, accepte les <abbr title="Conditions Générales de Vente">CGV</abbr> puis valide sa commande. Ce dernier clic forme la conclusion définitive du contrat. Dès validation, l’Acheteur reçoit un bon de commande confirmant l’enregistrement de sa commande. Dès réception du virement, la commande sera traitée et l’Acheteur en sera informé par e-mail. <abbr title="Coopérative Bretonne de E-Commerce">COBREC</abbr> expédiera les produits au plus tôt deux jours ouvrés après réception du virement correspondant à la commande, sous réserve de provisions.</p>
            <br>
            <p>L’ensemble des données fournies et la confirmation enregistrée vaudront preuve de la transaction.</p>
            <br>
            <p>Si l’Acheteur souhaite contacter <abbr title="Coopérative Bretonne de E-Commerce">COBREC</abbr>, il peut le faire soit par courrier à l’adresse suivante : 7 Rue Édouard Branly, 22300 Lannion ; soit par email à l’adresse suivante : cobrec@mail.bzh, soit par téléphone au 02 96 46 93 00.</p>
        </article>
        <article>

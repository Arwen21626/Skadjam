                ...
                <section class=" md:ml-32">
                    <?php foreach($avis as $row){
                        if ($row['contenu_commentaire'] != ''){
                            ...
                            ?>
                            <section class=" bg-bleu m-4 p-4 md:w-4xl w-2l <?php echo $aReponse?'mb-0 rounded-t-2xl':'rounded-2xl'?>">
                            ...
                            <section class=" bg-beige m-4 mt-0 p-4 w-4xl w-2l rounded-b-2xl">

...
<body>
    ...
    <main class="min-h-[600px]">
            ...
            <div class="mt-15 flex flex-row justify-around mb-15">
                <a href="../../php/supprimer_compte_client.php"><button class="border-4 border-vertClair rounded-xl w-auto h-14 px-7 cursor-pointer">Supprimer mon compte</button></a>

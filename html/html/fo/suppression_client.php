...
<body>
    ...
    <main class="min-h-[600px]">
            ...
            <div class="mt-15 flex flex-row justify-around mb-15">
                <a href="profil_client.php"><button class="mt-80 md:mt-0 border-2 border-vertClair rounded-xl w-40 h-14 px-7 cursor-pointer">Annuler</button></a>
                <a href="../../php/supprimer_compte_client.php"><button class="mt-80 md:mt-0 border-2 border-rouge rounded-xl w-40 h-14 px-7 cursor-pointer">Confirmer</button></a>
            </div>
        </main>

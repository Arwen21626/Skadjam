    ...
    <body class="relative h-1/1 flex flex-col">
        ...
        <main class="flex-1 flex flex-col justify-center items-center">
            ...
            <form method="POST" class="flex flex-col justify-center items-center flex-1 w-fit">
                ...
                <div class="flex flex-row w-full justify-around mt-10 mb-10">
                    <a href="profil_vendeur.php" class="flex items-center justify-center border-vertFonce border-2 rounded-2xl w-40 h-14 p-2 m-1 cursor-pointer">
                        Annuler
                    </a>
                    <input type="submit" value="Confirmer" class="border-vertFonce border-2 rounded-2xl w-40 h-14 p-2 m-1 cursor-pointer">
                </div>
            </form>
        </main>

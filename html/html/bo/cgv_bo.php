...
<body>
    ...
    <main class="m-10 mt-2 flex flex-col">
        ...
        <article>
            <h3 class="ml-5">Article 1 : Objet</h3>
            <p>Les présentes conditions de vente visent à définir les relations contractuelles entre COBREC et l’Acheteur et les conditions applicables à tout achat effectué par le biais du site internet Alizon.bzh. L’acquisition d’un produit à travers le présent site implique une acceptation sans réserve par l’Acheteur des présentes conditions de vente dont l’Acheteur reconnaît avoir pris connaissance préalablement à sa commande. Avant toute transaction, l’Acheteur déclare d’une part que l’achat de produits sur le site Alizon.bzh est sans rapport direct avec son activité professionnelle et est limité à une utilisation strictement personnelle et d’autre part avoir la pleine capacité juridique, lui permettant de s’engager au titre des présentes conditions générales de ventes.</p>
            <p>La société COBREC conserve la possibilité de modifier à tout moment ces conditions de ventes, afin de respecter toute nouvelle réglementation ou dans le but d'améliorer l’utilisation de son site. De ce fait, les conditions applicables seront celles en vigueur à la date de la commande par l’Acheteur.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 2 : Produits</h3>
            <p>Les produits proposés sont ceux qui figurent sur le site Alizon.bzh de la société COBREC, dans la limite des stocks disponibles. La société COBREC se réserve le droit de modifier à tout moment l’assortiment de produits. Chaque produit est présenté sur le site internet sous forme d’un descriptif reprenant ses principales caractéristiques techniques. Les photographies sont les plus fidèles possibles mais n’engagent en rien le Vendeur. La vente des produits présentés dans le site Alizon.bzh est destinée à tous les Acheteurs résidants en France métropolitaine.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 3 : Tarifs</h3>
            <p>Les prix figurant sur les fiches produits du catalogue internet et sont des prix en Euros (€) toutes taxes comprises (TTC) tenant compte de la TVA applicable au jour de la commande. Tout changement du taux de la TVA pourra être répercuté sur le prix des produits. La société COBREC se réserve le droit de modifier ses prix à tout moment, étant toutefois entendu que le prix figurant au catalogue le jour de la commande sera le seul applicable à l’Acheteur. Les prix indiqués ne comprennent pas les frais de livraison, facturés en supplément du prix des produits achetés suivant le montant total de la commande. En France métropolitaine, pour toute commande supérieure ou égale à 100€ TTC, les frais de port sont offerts ; pour toute commande inférieure à 100€ TTC, un forfait de participation aux frais d’expédition sera facturé à l’Acheteur d'un montant de 10€ TTC.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 4 : Commande et modalités de paiement</h3>
            ...
            <p>Si l’Acheteur souhaite contacter la société COBREC, il peut le faire soit par courrier à l’adresse suivante : 7 Rue Édouard Branly, 22300 Lannion ; soit par email à l’adresse suivante : cobrec@mail.bzh, soit par téléphone au 02 96 46 93 00.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 5 : Réserve de propriété</h3>
            <p>La société COBREC conserve la propriété pleine et entière des produits vendus jusqu'au parfait encaissement du prix, en principal, frais et taxes compris.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 6 : Rétractation</h3>
        ...
        <article>
            <h3 class="ml-5">Article 7 : Livraison</h3>
            <p>Les livraisons sont faites à l’adresse indiquée sur le bon de commande qui ne peut être que dans la zone géographique convenue. Les commandes sont effectuées par La Poste via un service de livraison avec suivi, remise sans signature. Les délais de livraison ne sont donnés qu’à titre indicatif ; si ceux-ci dépassent trente jours à compter de la commande, le contrat de vente pourra être résilié et l’Acheteur remboursé. La société COBREC pourra fournir par e-mail à l’Acheteur le numéro de suivi de son colis. L’Acheteur est livré à son domicile par son facteur. En cas d’absence de l’Acheteur, il recevra un avis de passage de son facteur, ce qui lui permet de retirer les produits commandés au bureau de Poste le plus proche, pendant un délai indiqué par les services postaux. Les risques liés au transport sont à la charge de l'acquéreur à compter du moment où les articles quittent les locaux de la société COBREC. L’Acheteur est tenu de vérifier en présence du préposé de La Poste ou du livreur, l’état de l’emballage de la marchandise et son contenu à la livraison. En cas de dommage pendant le transport, toute protestation doit être effectuée auprès du transporteur dans un délai de trois jours à compter de la livraison.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 8 : Garantie</h3>
            <p>Tous les produits fournis par la société COBREC bénéficient de la garantie légale prévue par les articles 1641 et suivants du Code civil. En cas de non conformité d’un produit vendu, il pourra être retourné à la société COBREC qui le reprendra, l’échangera ou le remboursera. Toutes les réclamations, demandes d’échange ou de remboursement doivent s’effectuer par voie postale à l’adresse suivante : 7 Rue Édouard Branly, 22300 Lannion, dans un délai de trente jours après livraison.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 9 : Responsabilité</h3>
            <p>La société COBREC, dans le processus de vente à distance, n’est tenue que par une obligation de moyens. Sa responsabilité ne pourra être engagée pour un dommage résultant de l’utilisation du réseau Internet tel que perte de données, intrusion, virus, rupture du service, ou autres problèmes involontaires.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 10 : Propriété intellectuelle</h3>
            <p>Tous les éléments du site Alizon.bzh sont et restent la propriété intellectuelle et exclusive de la société COBREC. Personne n’est autorisé à reproduire, exploiter, ou utiliser à quelque titre que ce soit, même partiellement, des éléments du site qu’ils soient sous forme de photo, logo, visuel ou texte.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 11 : Données à caractère personnel</h3>
            <p>La société COBREC s'engage à préserver la confidentialité des informations fournies par l’Acheteur, qu'il serait amené à transmettre pour l'utilisation de certains services. Toute information le concernant est soumise aux dispositions de la loi n° 78-17 du 6 janvier 1978. A ce titre, l'internaute dispose d'un droit d'accès, de modification et de suppression des informations le concernant. Il peut en faire la demande à tout moment par courrier à l’adresse suivante : 7 Rue Édouard Branly, 22300 Lannion.</p>
        </article>
        <article>
            <h3 class="ml-5">Article 12 : Règlement des litiges</h3>

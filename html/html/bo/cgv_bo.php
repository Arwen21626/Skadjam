...
<html lang="fr">
<head>
    <?php require "../../php/structure/head_back.php"; ?>
    <title>Conditions Générales de Vente</title>
</head>
<body>
    <?php
        require "../../php/structure/header_back.php";
        require "../../php/structure/navbar_back.php";
    ?>
    <main>
    ...
    <?php require "../../php/structure/footer_back.php"; ?>
</body>
</html>

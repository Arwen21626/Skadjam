    ...
    <main class="p-10 flex flex-col">
        ...
        <div class="flex flex-row justify-around  m-4 p-4">
            ...
            <div class="m-4 p-4 space-y-4 content-between">
                <!--affichage du prix-->
                <p class=" <?php echo ($produit['pourcentage_remise'] !== NULL)?'line-through':'';?>"> <?php echo htmlentities(str_replace(".", ",",$produit['prix_ttc'])); ?>€ (<abbr title="Toutes Taxes Confondues">TTC</abbr>)</p>
                <p class=" <?php echo ($produit['pourcentage_remise'] !== NULL)?'':'hidden';?>"> <?php echo htmlentities(str_replace(".", ",",$produit['prix_remise'])); ?>€ (<abbr title="Toutes Taxes Confondues">TTC</abbr>)</p>

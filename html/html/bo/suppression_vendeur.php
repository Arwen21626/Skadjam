...
<body>
    ...
    <main class="min-h-[600px]">
            ...
            <div class="mt-15 flex flex-row justify-around mb-15">
                <a href="profil_vendeur.php"><button class="border-4 border-vertFonce rounded-xl w-auto h-14 px-7 cursor-pointer">Annuler</button></a>
                <a href="../../php/supprimer_compte_vendeur.php"><button class="border-4 border-rouge rounded-xl w-auto h-14 px-7 cursor-pointer">Confirmer</button></a>
            </div>
        </main>

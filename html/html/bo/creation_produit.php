            ...
            <form id="formProduit" class="grid grid-cols-[40%_60%] w-4/5 self-center" action="creation_produit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-start-1 row-start-5 flex flex-col">
                    <div id="seuilInput" class="flex flex-row mr-4 ml-4">
                        ...
                        <input placeholder="10" class="pl-3 border-4 border-beige rounded-2xl w-45" type="number" name="seuilAlerte" min="0" id="seuilAlerte" value="<?php if(isset($seuilAlerte)){echo $seuilAlerte;} ?>">
                    </div>
                </div>

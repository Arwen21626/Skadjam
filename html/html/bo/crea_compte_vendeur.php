        ...
        <form method="POST" class="w-6/7">
            ...
            <div class="flex flex-col md:flex-row md:flex-wrap">
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3 w-60" type="text" id="nom" name="nom" value="<?= (!isset($erreurs["nom"])) ? $nom : '' ?>" size="25" required >
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3 w-60" type="text" id="prenom" name="prenom" value="<?= (!isset($erreurs["prenom"])) ? $prenom : '' ?>" size="25" required>
                    <!-- s'il y a une erreur elle sera affiché sous la cellule -->
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3 w-72" type="email" id="mail" name="mail" <?= (!(isset($erreurs["mail"]) || isset($erreurs["unique"]))) ? "value=\"$mail\"" : ''  ?> size="40" required>
                    <!-- s'il y a une erreur elle sera affiché sous la cellule -->
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3 w-40" type="tel" id="tel" name="tel" value="<?= (!isset($erreurs["tel"]))?$tel:''?>" size="16" required>
                    <!-- s'il y a une erreur elle sera affiché sous la cellule -->
            ...
            <div class="flex flex-col md:flex-row md:flex-wrap">
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3" type="text" id="raisonSociale" name="raisonSociale" value="<?= (!isset($erreurs["raisonSociale"]))? $raisonSociale: ''?>" size="40" required>
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3" type="text" id="denomination" name="denomination" value="<?= (!isset($erreurs["denomination"]))? $denomination: ''?>" size="40" required>
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3" type="text" id="iban" name="iban" value="<?= (!isset($erreurs["iban"]))?$iban: 'FR'?>" placeholder="FR" size="40" required>
            ...
            <div class="flex flex-col md:flex-row md:flex-wrap">
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <input class="border-4 border-solid rounded-2xl border-beige p-1 pl-3 placeholder-gray-500" type="text" id="adresse" name="adresse" value="<?= $_POST["adresse"] ?? ''?>" size="60" placeholder="ex : 3 rue des camélias" required>
            ...
            <div class="flex flex-col md:flex-row md:flex-wrap">
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <div class="zone-mdp flex flex-row">
                        <input class="champ-mdp border-4 border-solid rounded-2xl border-beige p-1 pl-3 w-60" type="password" id="mdp" name="mdp" value="<?= (!isset($erreurs["mdp"]) && isset($_POST["mdp"])) ? $_POST["mdp"] : ''?>" size="50" required>
                ...
                <div class="flex flex-col mt-2 mb-2">
                    ...
                    <div class="zone-mdp flex flex-row">
                        <input class="champ-mdp border-4 border-solid rounded-2xl border-beige p-1 pl-3 w-60" type="password" id="verif" name="verif" value="<?= (!(isset($erreurs["conf"]) || isset($erreurs["mdp"])) && isset($_POST["verif"])) ? $_POST["verif"] : ''?>" size="50" required>
                        <?php include __DIR__ . "/../../php/structure/bouton_mdp.php" ?>
                    </div>
                    <!-- s'il y a une erreur elle sera affiché sous la cellule -->
            ...
            <div class="flex flex-row m-4 justify-around">
                <a href="/index.php" class="cursor-pointer w-40 border-4 border-solid rounded-2xl border-beige p-1 pl-3 text-center"><button type="button">Annuler</button></a>
                <input type="submit" value="Valider" class="cursor-pointer w-40 border-4 border-solid rounded-2xl border-beige">
            </div>
        </form>

        <div class="flex flex-row flex-wrap">
            <!-- Lien vers la page de connexion -->
            <div class="flex flex-row flex-wrap justify-center mb-4 ml-4 mr-4 md:mb-10 md:ml-10 md:mr-10">

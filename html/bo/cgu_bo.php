...
<body>
    ...
    <article>
        <p>Les présentes conditions générales d'utilisation (dites « <bold>CGU</bold> ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par COBREC et de définir les conditions d’accès et d’utilisation des services par « l'<bold>Utilisateur</bold> ».</p>
        <br>
    ...
    <article>
        ...
        <p>Le site Alizon.bzh ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.</p>
        <br>
    ...
    <article>
        ...
        <br>
        <p>L’information contenue dans les cookies est utilisée pour améliorer le site Alizon.bzh.</p>
        <br>

...
mouvMap.addEventListener('click', function(){
    if (mouvMap.textContent == ">") {
        ...
        mouvMap.classList.add("md:w-45", "md:h-7", "md:right-0", "md:rounded-md", "md:bg-vertFonce/90")
        ...
        mouvMap.classList.remove("md:w-45", "md:h-7", "md:right-0", "md:rounded-md", "md:bg-vertFonce/90")
